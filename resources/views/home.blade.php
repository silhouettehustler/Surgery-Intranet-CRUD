                            ...
                            <div class="btn-group">
                                ...
                                @else
                                    <ul style="list-style-type: none; margin-right: 20px;">
                                        <li><button class="btn btn-outline-dark home-panel-list">My Prescriptions/Medications</button></li>
                                        ...
                                        <li><button class="btn btn-outline-danger home-panel-list">My Results</button></li>
                                    </ul>
